...
sum(as.numeric(CANCX_Active_pts_3$weight3)) # , OK
...
sum(as.numeric(CANCX_Active_pts_2$weight2)) # , OK
...
sum(as.numeric(noLines$weight3) * noLines$n) # 
...
mean(CANCX_Drug_Histories_v2$Lapsed) # 
mean(CANCX_Drug_Histories_v2$Lapsed[CANCX_Drug_Histories_v2$Death_Date!=61]) # 
